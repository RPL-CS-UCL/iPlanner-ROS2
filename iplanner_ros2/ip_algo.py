...
from . import planner_net
from . import percept_net
import sys
sys.modules['planner_net'] = planner_net
sys.modules['percept_net'] = percept_net
...
class IPlannerAlgo:
    def __init__(self, args):
        ...
        net, _ = torch.load(self.model_save, map_location=torch.device("cpu"), weights_only=False)
